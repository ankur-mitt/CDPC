    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('visitor', 'visitor'), ('student', 'student'), ('cordinator', 'cordinator'), ('recruiter', 'recruiter'), ('administrator', 'administrator')], max_length=50)),
